"""Default ToolRegistry factory — assembles the six built-in tools."""
...
def default_registry() -> ToolRegistry:
    ...
    Glob, and Grep. Each call returns a new instance so tests and
    production can have isolated state.
    """
    reg = ToolRegistry()
